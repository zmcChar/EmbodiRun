...
def build_parser() -> argparse.ArgumentParser:
    ...
    install = commands.add_parser("install", help="upload the current embodied_runtime source")
    install.add_argument(
        "--package-root",
        type=Path,
        help="override the local embodied_runtime package root (primarily for packaging tests)",
    )
