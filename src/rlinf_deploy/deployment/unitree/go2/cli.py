...
def build_parser() -> argparse.ArgumentParser:
    ...
    install = commands.add_parser("install", help="upload the current rlinf_deploy source")
    install.add_argument(
        "--package-root",
        type=Path,
        help="override the local rlinf_deploy package root (primarily for packaging tests)",
    )
