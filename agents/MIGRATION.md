...
| RLinf-deploy-managed-runtime/docs/astra-pi05-implementation.md | Managed-runtime design/evidence | Records proposed lifecycle, 50x12 output, and review/feedback limits | Reference only; do not import or copy embedded_runtime code |
